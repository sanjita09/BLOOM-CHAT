			...
			<div class="recieved-chats">
				...
				<p>	
					...
					// Check connection
						...
						//inserting the name of the chatroom_name
						
						$sql1 = "INSERT INTO chatrooms(name)
						VALUES ('$c_name')";
						if ($conn->query($sql1) === TRUE) 
						{
							$sql = "CREATE TABLE  $c_name(
							...
							{
								//echo 'Table Created'.$c_name; //using for testing purpose
							}
						}
						$q2="SELECT * FROM $c_name";
						$r2=$conn->query($q2);
						while($row=$r2->fetch_row())//added NN
						{
